...
export function useSnapshot(params: SnapshotParams) {
  const {
    ...
    setPixelSortThreshold, setPixelSortIntensity, setPixelSortDirection,
    setLightTrailsDecay, setLightTrailsThreshold, setLightTrailsIntensity,
