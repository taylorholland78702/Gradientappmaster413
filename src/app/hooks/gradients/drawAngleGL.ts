...
export function drawAngleGL(P: any): CanvasGradient | undefined {
  ...
  gl.uniform2f(gl.getUniformLocation(program, 'uCenter'), conicCenterX, conicCenterY);
  gl.uniform1f(gl.getUniformLocation(program, 'uZoom'), conicZoom);
  gl.uniform1f(gl.getUniformLocation(program, 'uStartAngle'), conicStartAngle);
