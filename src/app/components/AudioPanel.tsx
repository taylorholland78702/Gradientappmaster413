  ...
  return (
    <>
      ...
      <div className="w-full mb-0.5 flex gap-[3.5px]">
        ...
        <div className={`flex flex-1 items-center px-1 py-0.5 rounded-lg text-[10px] font-semibold shadow-lg gap-1 transition-all ${isMicActive ? 'bg-purple-500 text-white' : 'bg-white/8 backdrop-blur-sm text-white hover:bg-white/15'}`}>
          <button
        ...
        <button
          ...
          className="px-1 py-0.5 rounded-lg text-[10px] transition-all bg-white/8 backdrop-blur-sm text-white hover:bg-white/15 font-semibold shadow-lg flex items-center gap-1"
