...
import { useDatamoshState } from '../hooks/state/useDatamoshState';
...
export function InteractiveGradient() {
  ...
  const { datamoshBlockSize, setDatamoshBlockSize, datamoshAmount, setDatamoshAmount } = useDatamoshState();
  ...
  const drawParams = useMemo(() => ({
    ...
    noiseDirection,
    ditherType, ditherLevels, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, watercolorStyle, cubismFacetSize, cubismOffset, popTiles, popHueShift, futurismEchoes, futurismSpread, datamoshBlockSize, datamoshAmount, dadaPanels, dadaChaos, surrealMelt, surrealMirror, slitScanIntensity, slitScanDirection, slitScanHistory,
...
// Flow Field's canvas is a persistent low-alpha trail buffer, not a full
  ...
  useCanvasDraw({
    ...
    concentricRingWidth, helixTightness, helixTurns, ditherLevels, ditherType, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, watercolorStyle, cubismFacetSize, cubismOffset, popTiles, popHueShift, futurismEchoes, futurismSpread, datamoshBlockSize, datamoshAmount, dadaPanels, dadaChaos, surrealMelt, surrealMirror, drawParams,
    glitchIntensity, glitchBlockSize, glitchChromaSplit,
    auraGlowCount, auraGlowSpeed, auraGlowOpacity,
