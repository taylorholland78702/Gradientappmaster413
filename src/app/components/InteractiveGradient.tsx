...
export function InteractiveGradient() {
  ...
  const { watercolorBleed, setWatercolorBleed, watercolorGrain, setWatercolorGrain } = useWatercolorState();
  ...
  const drawParams = useMemo(() => ({
    ...
    noiseDirection,
    ditherType, ditherLevels, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, slitScanIntensity, slitScanDirection, slitScanHistory,
...
// Flow Field's canvas is a persistent low-alpha trail buffer, not a full
  ...
  useCanvasDraw({
    ...
    concentricRingWidth, helixTightness, helixTurns, ditherLevels, ditherType, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, drawParams,
    glitchIntensity, glitchBlockSize, glitchChromaSplit,
    auraGlowCount, auraGlowSpeed, auraGlowOpacity,
