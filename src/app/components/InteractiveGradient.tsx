...
export function InteractiveGradient() {
  ...
  useCanvasDraw({
    ...
    flowerScale, flowerSpread, gradientAngle, gradientAngleRef, gradientColors, gradientColorsRef,
