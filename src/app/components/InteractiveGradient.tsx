...
export function InteractiveGradient() {
  ...
  const { buildSnapshot, applySnapshot } = useSnapshot({
    ...
    attractorPointCount, attractorScale, attractorSpeed, setAttractorPointCount, setAttractorScale, setAttractorSpeed,
          ...
          <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-sm mx-6 max-h-[80vh] overflow-y-auto text-white shadow-2xl">
            ...
            <div className="flex flex-col gap-8 text-sm text-white/80 leading-relaxed mt-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="flex items-center justify-between gap-2"><span className="flex items-center gap-2"><EyeSlash weight="regular" className="w-4 h-4 shrink-0" /> Eye again — fully hide all UI for live/projector output</span><Kbd label="H H" /></p>
