...
export function InteractiveGradient() {
  ...
  const { tilingSize, setTilingSize, tilingSymmetry, setTilingSymmetry, tilingComplexity, setTilingComplexity, tilingRotation, setTilingRotation } = useTilingState();
