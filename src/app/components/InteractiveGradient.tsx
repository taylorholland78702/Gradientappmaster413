...
export function InteractiveGradient() {
  ...
  const drawParams = useMemo(() => ({
    ...
    noiseDirection,
    ditherType, ditherLevels, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, watercolorStyle, slitScanIntensity, slitScanDirection, slitScanHistory,
...
// Flow Field's canvas is a persistent low-alpha trail buffer, not a full
  ...
  useCanvasDraw({
    ...
    concentricRingWidth, helixTightness, helixTurns, ditherLevels, ditherType, ditherScale, oilPaintRadius, oilPaintLevels, watercolorBleed, watercolorGrain, watercolorStyle, drawParams,
    glitchIntensity, glitchBlockSize, glitchChromaSplit,
    auraGlowCount, auraGlowSpeed, auraGlowOpacity,
