    ...
    <>
      ...
      <div className="flex gap-[3.5px] w-full mb-0.5">
        <button
          ...
          className="flex-1 px-1 py-0.5 rounded-lg text-[10px] transition-all bg-white/8 backdrop-blur-sm text-white hover:bg-white/15 flex items-center justify-between font-semibold"
        >
          <span>Presets</span>
