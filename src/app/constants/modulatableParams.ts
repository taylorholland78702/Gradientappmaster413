...
export const MODULATABLE_PARAMS: ModulatableParam[] = [
  ...
  { key: 'confettiCount', label: 'Confetti Count', category: 'Confetti', min: 20.0, max: 500.0 },
  ...
  { key: 'starfieldCount', label: 'Starfield Count', category: 'Starfield', min: 30.0, max: 500.0 },
