...
export const MODULATABLE_PARAMS: ModulatableParam[] = [
  ...
  { key: 'cubismFacetSize', label: 'Cubism Facet Size', category: 'Cubism', min: 10.0, max: 60.0 },
  ...
  { key: 'futurismEchoes', label: 'Futurism Echoes', category: 'Futurism', min: 2.0, max: 8.0 },
  { key: 'futurismSpread', label: 'Futurism Spread', category: 'Futurism', min: 2.0, max: 40.0 },
  ...
  { key: 'popTiles', label: 'Pop Art Tiles', category: 'Pop Art', min: 2.0, max: 6.0 },
  { key: 'popHueShift', label: 'Pop Art Hue Shift', category: 'Pop Art', min: 0.0, max: 360.0 },
  ...
  { key: 'starfieldSize', label: 'Starfield Size', category: 'Starfield', min: 0.2, max: 4.0 },
