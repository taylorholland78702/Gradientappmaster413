...
export const MODULATABLE_PARAMS: ModulatableParam[] = [
  ...
  { key: 'watercolorOpacity', label: 'Watercolor Opacity', category: 'Watercolor', min: 0.15, max: 0.85 },
  ...
  { key: 'circuitLineWidth', label: 'Circuit Line Width', category: 'Circuit', min: 0.3, max: 4.0 },
