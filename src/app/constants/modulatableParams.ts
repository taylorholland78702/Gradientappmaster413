...
export const MODULATABLE_PARAMS: ModulatableParam[] = [
  ...
  { key: 'colorFieldPanels', label: 'Color Field Panels', category: 'Color Field', min: 2.0, max: 6.0 },
  { key: 'colorFieldDrift', label: 'Color Field Drift', category: 'Color Field', min: 0.0, max: 1.0 },
  { key: 'colorFieldPulse', label: 'Color Field Pulse', category: 'Color Field', min: 0.0, max: 1.0 },
  ...
  { key: 'turrellSpeed', label: 'Turrell Speed', category: 'Turrell', min: 0.1, max: 2.0 },
  { key: 'turrellGlow', label: 'Turrell Glow', category: 'Turrell', min: 0.0, max: 1.0 },
