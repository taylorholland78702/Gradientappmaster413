...
export const MODULATABLE_PARAMS: ModulatableParam[] = [
  ...
  { key: 'confettiCount', label: 'Confetti Count', category: 'Confetti', min: 20.0, max: 200.0 },
  { key: 'confettiSpeed', label: 'Confetti Speed', category: 'Confetti', min: 0.2, max: 3.0 },
  { key: 'confettiOpacity', label: 'Confetti Opacity', category: 'Confetti', min: 0.1, max: 1.0 },
  ...
  { key: 'fluidFieldScale', label: 'Fluid Field Scale', category: 'Fluid Field', min: 0.5, max: 10.0 },
  { key: 'fluidFieldSpeed', label: 'Fluid Field Speed', category: 'Fluid Field', min: 0.1, max: 3.0 },
  { key: 'fluidFieldOpacity', label: 'Fluid Field Opacity', category: 'Fluid Field', min: 0.1, max: 1.0 },
  ...
  { key: 'lightningWebCount', label: 'Lightning Web Count', category: 'Lightning Web', min: 4.0, max: 20.0 },
  { key: 'lightningWebSpeed', label: 'Lightning Web Speed', category: 'Lightning Web', min: 0.2, max: 3.0 },
  { key: 'lightningWebOpacity', label: 'Lightning Web Opacity', category: 'Lightning Web', min: 0.1, max: 1.0 },
  ...
  { key: 'particleTrailsCount', label: 'Particle Trails Count', category: 'Particle Trails', min: 10.0, max: 150.0 },
  { key: 'particleTrailsSpeed', label: 'Particle Trails Speed', category: 'Particle Trails', min: 0.1, max: 3.0 },
  { key: 'particleTrailsOpacity', label: 'Particle Trails Opacity', category: 'Particle Trails', min: 0.1, max: 1.0 },
  ...
  { key: 'starfieldCount', label: 'Starfield Count', category: 'Starfield', min: 30.0, max: 250.0 },
  { key: 'starfieldSpeed', label: 'Starfield Speed', category: 'Starfield', min: 0.2, max: 4.0 },
  { key: 'starfieldOpacity', label: 'Starfield Opacity', category: 'Starfield', min: 0.1, max: 1.0 },
  { key: 'staticFieldIntensity', label: 'Static Field Intensity', category: 'Static Field', min: 0.05, max: 1.0 },
  { key: 'staticFieldBarSpeed', label: 'Static Field Bar Speed', category: 'Static Field', min: 0.1, max: 3.0 },
  { key: 'staticFieldOpacity', label: 'Static Field Opacity', category: 'Static Field', min: 0.1, max: 1.0 },
  ...
  { key: 'triangleFieldGridSize', label: 'Triangle Field Grid Size', category: 'Triangle Field', min: 4.0, max: 24.0 },
  { key: 'triangleFieldSpeed', label: 'Triangle Field Speed', category: 'Triangle Field', min: 0.1, max: 3.0 },
  { key: 'triangleFieldOpacity', label: 'Triangle Field Opacity', category: 'Triangle Field', min: 0.1, max: 1.0 },
  ...
  { key: 'voronoiCellsCount', label: 'Voronoi Cells Count', category: 'Voronoi Cells', min: 3.0, max: 14.0 },
  { key: 'voronoiCellsSpeed', label: 'Voronoi Cells Speed', category: 'Voronoi Cells', min: 0.1, max: 3.0 },
  { key: 'voronoiCellsOpacity', label: 'Voronoi Cells Opacity', category: 'Voronoi Cells', min: 0.1, max: 1.0 },
  ...
  { key: 'windStreaksCount', label: 'Wind Streaks Count', category: 'Wind Streaks', min: 15.0, max: 150.0 },
  { key: 'windStreaksSpeed', label: 'Wind Streaks Speed', category: 'Wind Streaks', min: 0.2, max: 4.0 },
  { key: 'windStreaksOpacity', label: 'Wind Streaks Opacity', category: 'Wind Streaks', min: 0.1, max: 1.0 },
